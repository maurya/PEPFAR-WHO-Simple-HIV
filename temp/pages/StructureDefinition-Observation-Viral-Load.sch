...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'https://github.com/maurya/PEPFAR-WHO-Simple-HIV/StructureDefinition/VL-reason']) &lt;= 1">extension with URL = 'https://github.com/maurya/PEPFAR-WHO-Simple-HIV/StructureDefinition/VL-reason': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
